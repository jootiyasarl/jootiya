...
export function MessagingClient({ initialConversations, currentUser }: MessagingClientProps) {
    ...
    return (
        <div className="flex h-[calc(100vh-64px)] md:h-[600px] w-full overflow-hidden md:rounded-3xl md:border md:border-zinc-200 bg-white md:shadow-2xl -mx-4 -mt-8 -mb-20 md:m-0">
            ...
            <div className={cn(
                "w-full md:w-80 lg:w-96 flex flex-col border-r border-zinc-100 bg-white shadow-sm md:shadow-none",
                selectedId ? "hidden md:flex" : "flex"
            )}>
                <div className="p-4 md:p-6 border-b border-zinc-100 bg-white sticky top-0 z-10">
                    <h2 className="text-lg md:text-xl font-black text-zinc-900 uppercase tracking-tight mb-3 md:mb-4">Messages</h2>
            ...
            {/* Main Chat Area */}
            <div className={cn(
                "flex-1 flex-col bg-zinc-50/30 w-full",
