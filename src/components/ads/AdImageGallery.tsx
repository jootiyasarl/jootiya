        ...
        <div className="flex flex-col gap-4">
            ...
            {isLightboxOpen && (
                <div className="fixed inset-0 z-[99999] flex flex-col bg-black animate-in fade-in duration-300">
                    <div className="flex items-center justify-between p-4 z-[100001] bg-gradient-to-b from-black/80 to-transparent absolute top-0 left-0 right-0">
                    ...
                    {images.length > 1 && (
                        <>
                            <button
                                ...
                                className="absolute left-4 top-1/2 -translate-y-1/2 p-4 text-white/50 hover:text-white transition-colors z-[100001] bg-black/20 hover:bg-black/40 rounded-full"
                            >
                                <ChevronLeft className="h-10 w-10" />
                            </button>
                            <button
                                onClick={(e) => { e.stopPropagation(); scrollNextLightbox(); }}
                                className="absolute right-4 top-1/2 -translate-y-1/2 p-4 text-white/50 hover:text-white transition-colors z-[100001] bg-black/20 hover:bg-black/40 rounded-full"
                            >
                    ...
                    <div className="absolute bottom-10 left-0 right-0 flex justify-center gap-2 z-[100001]">
                        {images.map((_, i) => (
                            <div
                                key={i}
                                className={cn(
