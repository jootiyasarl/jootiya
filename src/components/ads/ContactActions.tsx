    ...
    return (
        <div className="space-y-3">
            <button
                ...
                className="btn btn-success w-full h-14 text-lg gap-3"
            >
            ...
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
                <DialogTrigger className="btn btn-outline btn-primary w-full h-14 text-lg gap-3">
                    <MessageCircle className="h-5 w-5" />
                    Envoyer un message
                </DialogTrigger>
                <DialogContent className="sm:max-w-md bg-white rounded-3xl border-zinc-100 shadow-2xl p-0 overflow-hidden gap-0 z-[99999]">
                    ...
                    <div className="p-6 pt-2 space-y-4">
                        <textarea
                            ...
                            className="textarea textarea-bordered w-full min-h-[120px] resize-none text-[16px]"
                            value={message}
