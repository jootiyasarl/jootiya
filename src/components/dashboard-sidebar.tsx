    ...
    <aside className="h-full border-r bg-white flex flex-col dark:bg-zinc-950 dark:border-zinc-800">
      <div className="flex h-16 md:h-20 items-center px-6 border-b border-zinc-100 dark:border-zinc-800">
        <Link href="/" className="flex items-center gap-2 group">
          <div className="w-8 h-8 rounded-lg bg-orange-600 flex items-center justify-center text-white shadow-lg shadow-orange-100 group-hover:scale-110 transition-transform">
            <TrendingUp className="w-5 h-5" />
          </div>
          <span className="text-xl font-black tracking-tighter text-zinc-900 dark:text-white uppercase">
            JOOTIYA <span className="text-orange-600">Pro</span>
          </span>
        </Link>
      </div>

      <nav className="flex-1 overflow-y-auto py-8 px-4 space-y-9 no-scrollbar menu w-full">
        {sections.map((section, idx) => (
          <div key={idx} className="space-y-3">
            <h3 className="menu-title px-3 text-[11px] font-black uppercase tracking-[0.2em] text-zinc-500 dark:text-zinc-400">
              {section.title}
            </h3>
                  ...
                  <li key={item.href}>
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "active bg-orange-600 text-white shadow-lg shadow-orange-100 dark:shadow-none"
      ...
      <div className="p-5 border-t border-zinc-100 dark:border-zinc-800">
        <div className="rounded-2xl bg-zinc-900 p-5 text-white shadow-2xl relative overflow-hidden group">
          <div className="absolute -right-4 -top-4 w-24 h-24 bg-orange-600/20 rounded-full blur-2xl group-hover:bg-orange-600/30 transition-colors" />
