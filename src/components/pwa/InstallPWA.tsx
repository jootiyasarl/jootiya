...
export default function InstallPWA() {
  ...
  useEffect(() => {
    ...
    if (isStandalone) {
      // If installed but not subscribed, ask quietly
    ...
    const handler = (e: any) => {
      e.preventDefault();
      setDeferredPrompt(e);
      setShowBanner(true); // Always show if possible
    };
      ...
      <div className="bg-zinc-950/95 border-t border-orange-600/30 p-4 backdrop-blur-md shadow-[0_-10px_40px_rgba(234,88,12,0.15)]">
        <div className="max-w-xl mx-auto flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-white font-bold text-sm leading-none">Application Jootiya</h3>
              <p className="text-zinc-500 text-[10px] mt-1">Installez l'app pour les meilleures offres</p>
            </div>
          </div>
