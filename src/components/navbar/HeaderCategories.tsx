...
export function HeaderCategories() {
    ...
    return (
        <div className="fixed top-16 left-0 right-0 z-40 w-full bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md border-b border-zinc-100 dark:border-zinc-800">
            <div className="mx-auto max-w-7xl px-4 md:px-6">
                <div className="flex w-full items-center justify-between gap-2 overflow-x-auto py-3 scrollbar-hide">
                    <Link
                        href="/marketplace"
                        className={cn(
                            "group flex min-w-fit flex-col items-center gap-1.5 transition-all relative pb-2",
