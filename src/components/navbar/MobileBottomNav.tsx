...
export function MobileBottomNav() {
    ...
    return (
        <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl border-t border-zinc-100 dark:border-zinc-800 px-2 shadow-[0_-10px_20px_rgba(0,0,0,0.02)] pb-[env(safe-area-inset-bottom)]">
            <div className="grid h-14 min-[360px]:h-16 grid-cols-5 mx-auto max-w-md items-center px-0 min-[360px]:px-1">
                <Link
                    href="/"
                    className={cn(
                    ...
                    aria-label="Accueil"
                >
                    <Home className="w-5 h-5 min-[360px]:w-6 min-[360px]:h-6 group-hover:text-orange-600" />
                    <span className="text-[9px] min-[360px]:text-[10px] font-bold uppercase tracking-tighter group-hover:text-orange-600">
                        Accueil
                    </span>
                </Link>
                ...
                >
                    <Heart className="w-5 h-5 min-[360px]:w-6 min-[360px]:h-6 group-hover:text-orange-600" />
                    <span className="text-[9px] min-[360px]:text-[10px] font-bold uppercase tracking-tighter group-hover:text-orange-600">
                        Favoris
                    </span>
                </Link>
                ...
                <Link
                    ...
                    className="inline-flex flex-col items-center justify-center min-h-[44px] min-w-[44px] px-1 min-[360px]:px-2 group relative -top-4 min-[360px]:-top-5"
                    aria-label="Vendre un article"
                >
                    <div className="p-2.5 min-[360px]:p-3 bg-orange-500 rounded-full shadow-lg shadow-orange-200 group-hover:bg-orange-600 transition-all border-4 border-white active:scale-95">
                        <PlusCircle className="w-5 h-5 min-[360px]:w-6 min-[360px]:h-6 text-white" />
                    </div>
                    <span className="text-[9px] min-[360px]:text-[10px] font-bold text-orange-500 mt-0.5 min-[360px]:mt-1">Vendre</span>
                </Link>
                ...
                >
                    <MessageCircle className="w-5 h-5 min-[360px]:w-6 min-[360px]:h-6 group-hover:text-orange-600" />
                    <span className="text-[9px] min-[360px]:text-[10px] font-bold uppercase tracking-tighter group-hover:text-orange-600">
                        Messages
                    </span>
                </Link>
                ...
                >
                    <User className="w-5 h-5 min-[360px]:w-6 min-[360px]:h-6 group-hover:text-orange-600" />
                    <span className="text-[9px] min-[360px]:text-[10px] font-bold uppercase tracking-tighter group-hover:text-orange-600">
                        Profil
                    </span>
                </Link>
