...
export default async function PublicNavbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full bg-white dark:bg-zinc-950 border-b border-zinc-100 dark:border-zinc-800 h-14 md:h-16 flex flex-col justify-center">
      <div className="mx-auto max-w-7xl w-full px-4 md:px-6">
        {/* Main Nav Row */}
        <div className="flex items-center justify-between gap-8 relative h-full">
