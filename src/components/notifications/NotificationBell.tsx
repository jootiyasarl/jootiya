        ...
        <div className="relative" ref={dropdownRef}>
            ...
            >
                <div className="relative p-1.5 rounded-full group-hover:bg-zinc-100 transition-colors">
                    <Bell className="h-5 w-5 text-zinc-800 group-hover:text-orange-600 transition-colors" />
                    {unreadCount > 0 && (
                    ...
                    <div className="p-4 border-b border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
                        ...
                        {unreadCount > 0 && (
                            <button
                                ...
                                className="text-xs font-medium text-orange-600 hover:text-orange-700 dark:text-orange-400 transition-colors"
                            >
                    ...
                    <div className="max-h-[400px] overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-zinc-200 dark:scrollbar-thumb-zinc-700">
                        {loading ? (
                            <div className="p-8 text-center">
                                <div className="inline-block h-6 w-6 animate-spin rounded-full border-2 border-zinc-200 border-t-orange-600" />
                            </div>
                                ...
                                {notifications.map((notification) => (
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            !notification.is_read && "bg-orange-50/30 dark:bg-orange-900/10"
                                        )}
                                            ...
                                            <div className="flex-1 space-y-1">
                                                ...
                                                {notification.link && (
                                                    <Link
                                                        ...
                                                        className="inline-flex items-center gap-1 mt-2 text-[11px] font-medium text-orange-600 hover:underline"
                                                        onClick={(e) => {
                                                            e.stopPropagation();
                                                            setIsOpen(false);
                                                        }}
