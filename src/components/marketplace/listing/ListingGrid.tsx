...
export function ListingGrid({ items, isLoading, skeletonCount = 8, searchQuery, category, city }: ListingGridProps) {
  if (isLoading) {
    return (
      <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 px-4 md:px-6 max-w-7xl mx-auto w-full @[max-width:640px]:grid-cols-[repeat(2,minmax(0,1fr))]">
